...
%% Settings
display = 'none';
folderPath = fullfile(pwd,"ParameterTuning");
baseFileName = 'trial';

%% Optimization
FinalValidationLoss = @(params) trainNetworkAndReturnValidationLoss_FromScratch(params,dataset,folderPath,baseFileName,display);
